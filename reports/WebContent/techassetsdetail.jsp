...
<% 
  	String title =  "FIS Tech Upgrade Assets Report Page"; 
	ArrayList<String> list = new ArrayList<String>();
	ArrayList<String> tokens = new ArrayList<String>();
	String formUrl =  (String) session.getAttribute("formUrl");
	ArrayList<String>  strArr = (ArrayList<String>) session.getAttribute("strArr");
...
/*****************************************************************************************************************************************************************/
	...
	String filePath = "C:\\Java_Dev\\props\\headers\\techAssetHdr.txt";
