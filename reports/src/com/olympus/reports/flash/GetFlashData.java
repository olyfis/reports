...
public class GetFlashData extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		long msTot =  (long) obj.get("msSum");
		long mtTot =  (long) obj.get("mtSum");
		long qsTot =  (long) obj.get("qsSum");
		long qtTot =  (long) obj.get("qtSum");
		long ysTot =  (long) obj.get("ysSum");
		long ytTot =  (long) obj.get("ytSum");
