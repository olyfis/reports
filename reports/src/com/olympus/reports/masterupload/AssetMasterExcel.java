...
import com.opencsv.CSVReader;
	...
	@WebServlet("/amasterexcel")
	public class AssetMasterExcel  extends HttpServlet {
		...
		public static void loadHeader2(SXSSFWorkbook wbss, SXSSFSheet sheet, ArrayList<String> headerArr, Map<String, CellStyle> styles) {
	        ...
	        setSheetTitle( wbss,  sheet,  styles, "Asset Master Upload Report", "$A$1:$P$1" ); 
			...
			for (String str : strArr) { // iterating ArrayList
				...
				for (String token : strSplitArr) {
					...
					//System.out.print(token + "--");
					 if (colNum == 9 || colNum == 10 || colNum == 21  || colNum == 22 ) {
		...
		protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
			String headerFilename = "C:\\Java_Dev\\props\\headers\\assetMasterHdr.txt";
			String outputFileName = "C:\\temp\\assetMaster.txt";
			...
			String fileName= "Asset_Master_Report_" + dateStamp + ".xlsx";
	       ...
	       // System.out.println("End writeFile:" + timestampWe);
			...
			SXSSFSheet sheet =   wbss.createSheet("Asset Master Upload Report");	
